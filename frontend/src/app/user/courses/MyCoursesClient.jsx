      ...
      {activeCourses.length === 0 ? (
        ...
        <>
          <div className="mb-10 text-center">
            ...
            <h2 className="text-4xl font-bold text-gray-900">Course Details</h2>
          </div>
                ...
                >
                  ...
                  <div className="space-y-4">
                    {(course.chapters || []).map((chapter, index) => {
                      ...
                      const isChapterCompleted = Math.round(progress) >= 100;
                      ...
                      return (
                        <div key={chapter.chId} className="space-y-3">
                          <div
                            ...
                            className="relative w-full cursor-pointer overflow-hidden rounded-xl border border-gray-200 bg-gray-100 text-left"
                          >
                            <div
                              ...
                              <div className="flex items-center gap-2">
                                ...
                                {isChapterCompleted &&
                                  ...
                                  chapterExams.map((exam) =>
                                    exam.hasResult ? null : exam.canStart ? (
                                      <button
                                        key={exam.examId}
                                        onClick={(e) => {
                                          e.stopPropagation();
                                          router.push(
                                            `/user/exams/${exam.examId}/start`,
                                          );
                                        }}
                                      ...
                                      <button
                                        ...
                                        disabled
                                        className="rounded-full bg-gray-300 p-1.5 text-gray-500"
                                        title={exam.lockReason}
                                      >
  ...
  return (
    <div
      className={`rounded-2xl border p-4 shadow-sm ${
        locked ? "border-gray-200 bg-gray-50" : "border-green-200 bg-green-50"
      }`}
    >
